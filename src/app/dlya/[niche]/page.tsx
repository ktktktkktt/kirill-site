    ...
    <main className="bg-bg text-light min-h-screen">
      ...
      <section className="py-24 px-6 lg:px-12 border-t border-border">
        ...
        <h2 className="font-display text-3xl text-light uppercase mb-8">
          Сайт под специфику ниши
        </h2>
        <p className="font-body text-light/60 max-w-3xl leading-relaxed">
          Для {niche.nameShort.toLowerCase()} важны не только внешний вид и скорость.
          Страница должна отвечать на типовые возражения клиента, показывать доверие,
          объяснять процесс и вести к заявке без лишних шагов.
        </p>
      </section>
